...
<div class="mt-3">
    <table class="table table-bordered" style="color: #787878">
        ...
        <tbody>
            ...
            @php
            $kpsp = DB::select("SELECT * FROM pertanyaan as a left join kelompok_gerak as b on b.id_gerak =
            a.id_gerak where a.kelompok_pertanyaan = '2' and id_kel_kpsp = $k->id_kel_kpsp");
            @endphp
            <tr>
            ...
            <tr>
                ...
                <td style="vertical-align: middle;" class="{{ $warna }}">
                    {{ $p->nm_gerak }}</td>
                <td style="vertical-align: middle; text-align: center"><i class="fas text-success fa-check"></i>
                </td>
...
<div class="mt-3">
    <button class="btn btn-primary back1" type="button" step_number="1">Prev</button>
    <button class="btn btn-primary next3" type="submit" step_number="3">Next</button>
</div>